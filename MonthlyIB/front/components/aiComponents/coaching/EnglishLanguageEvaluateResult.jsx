// components/aiComponents/coaching/EnglishLanguageEvaluateResult.jsx
// Evaluate 전용 컴포넌트 (고정 스키마에 맞춤)

import React from "react";
import styles from "./EnglishGeneratedGuide.module.css";

/**
 * Evaluate 응답 전용 뷰 (고정 스키마)
 * 입력 예시(백엔드 고정):
 * {
 ...
 * }
 */
export default function EnglishLanguageEvaluateResult({ data, onReset, onCreateDraft }) {
  if (!data) return null;
        ...
        <section className={styles["section"]}>
          <div className={styles["actions"]}>
            <button
              ...
              aria-label="Create a draft with the evaluated topic"
            >
              🧾 이 주제로 Draft 생성하기
            </button>
            ...
            <button
              ...
              onClick={onReset}
              disabled={!onReset}
              aria-label="Reset English coaching flow"
            >
              🧹 초기화
            </button>
          </div>
