...
import { courseCategoryList } from "../../page_components/course/CourseComponents";

const CoursePostCategory = ({ group, handleGroupChange, handleSubjectChange, handleLevelChange }) => {
