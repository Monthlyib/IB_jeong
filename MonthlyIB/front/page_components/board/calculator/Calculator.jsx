...
const Calculator = () => {
    ...
    const [group, setGroup] = useState(["all", "all", "all", "all", "all", "all"]);
        ...
        <>
            <main className="width_content archive" >
                ...
                <div className={styles.calc_result}>
                    <p>총 점수 : <span id={styles.result}>{totalPoint}</span>점</p>
                </div>

                <div className={styles.recommend_schools_wrap}>
                    <div className={styles.recommend_schools_top}>
                        <h3>추천학교</h3>
                        <select id={styles.recommendSchools} onChange={handleCountryChange} value={country}>
