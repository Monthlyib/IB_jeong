...
const addcard = () => {
  ...
  //   const { customerKey } = router.query;
  ...
  //         successUrl: "http://localhost:3000/addcard/success", // 카드 등록에 성공하면 이동하는 페이지(직접 만들어주세요)
  //         failUrl: "http://localhost:3000/addcard/fail", // 카드 등록에 실패하면 이동하는 페이지(직접 만들어주세요)
  //       })
  //       // ------ 결제창을 띄울 수 없는 에러 처리 ------
