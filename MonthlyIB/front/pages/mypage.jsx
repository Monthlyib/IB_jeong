...
import MyPageArchiveList from "../page_components/mypage/MyPageArchiveList";
import MyPageCourseList from "../page_components/mypage/MyPageCourseList";
import MyPageQuestionList from "../page_components/mypage/MyPageQuestionList";
import MyPageScheduleList from "../page_components/mypage/MyPageScheduleList";
import MyPageChangePayment from "../page_components/mypage/MyPageChangePayment";
          ...
          <div className={styles.mypage_flex}>
            <div className={styles.flex_left}>
              <div className={styles.my_profile_wrap}>
                ...
                <Link href="/validate" className={styles.my_validate_btn}>
