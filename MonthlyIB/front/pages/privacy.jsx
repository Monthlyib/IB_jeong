            ...
            <AppLayout>
                ...
                <main className="width_content min_content polic">
                    ...
                    <div className="polic_content">
                        (이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.<br />
                        <br />
                        ...
                        <br />
                        <br />
                        <strong>제9조(권익침해 구제 방법)</strong><br />
                        ...
                        <br />
                        <br />
                        <strong>제10조(개인정보 처리방침 시행 및 변경)</strong><br />
